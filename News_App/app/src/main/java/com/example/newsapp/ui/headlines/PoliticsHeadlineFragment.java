 ...
 */
public class PoliticsHeadlineFragment extends Fragment implements HeadlinesNewsAdapter.OnNewsItemListener {
    private static final String TAG = "POLITICS_FRAGMENT";
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private PoliticsHeadlineFragment fragment;
    private ArrayList<HeadlinesNewsItem> newsList;
    private Context thiscontext;

    private ProgressBar mProgressBar;

    public PoliticsHeadlineFragment() {
        fragment = this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View root = inflater.inflate(R.layout.fragment_politics_headline, container, false);
        thiscontext = container.getContext();
        mProgressBar = root.findViewById(R.id.progressBar_politics);
        ...
        mRecyclerView = root.findViewById(R.id.politics_recyclerview);
        mAdapter = new HeadlinesNewsAdapter(newsList, fragment, thiscontext);
        newsList = getNews(thiscontext, root);

        final SwipeRefreshLayout swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_items_politics);
    ...
    private ArrayList<HeadlinesNewsItem> getNews(final Context thiscontext, final View root){
        ...
        String url = "https://node-assignment9-ugru.wl.r.appspot.com/guardian/politics";
