 ...
 */
public class TechnologyHeadlineFragment extends Fragment implements HeadlinesNewsAdapter.OnNewsItemListener{
    private static final String TAG = "WORLD_FRAGMENT";
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private TechnologyHeadlineFragment fragment;
    private ArrayList<HeadlinesNewsItem> newsList;
    private Context thiscontext;
    private ProgressBar mProgressBar;

    public TechnologyHeadlineFragment() {
        fragment = this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View root = inflater.inflate(R.layout.fragment_technology_headline, container, false);
        thiscontext = container.getContext();
        mProgressBar = root.findViewById(R.id.progressBar_technology);
        ...
        mRecyclerView = root.findViewById(R.id.technology_recycler_view);
        mAdapter = new HeadlinesNewsAdapter(newsList, fragment, thiscontext);

        newsList = getNews(thiscontext, root);

        final SwipeRefreshLayout swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_items_technology);
    ...
    private ArrayList<HeadlinesNewsItem> getNews(final Context thiscontext, final View root){
        ...
        String url = "https://node-assignment9-ugru.wl.r.appspot.com/guardian/technology";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i = 0; i < results.length(); i++) {
                                ...
                                JSONObject blocksObject = jsonObject != null ? jsonObject.getJSONObject("blocks") : null;
