 ...
 */
public class ScienceHeadlineFragment extends Fragment implements HeadlinesNewsAdapter.OnNewsItemListener{
    private static final String TAG = "SCIENCE_FRAGMENT";
    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private ScienceHeadlineFragment fragment;
    private ArrayList<HeadlinesNewsItem> newsList;
    private Context thiscontext;
    private ProgressBar mProgressBar;
    public ScienceHeadlineFragment() {
        fragment = this;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View root = inflater.inflate(R.layout.fragment_science_headline, container, false);
        thiscontext = container.getContext();
        mProgressBar = root.findViewById(R.id.progressBar_science);
        ...
        mRecyclerView = root.findViewById(R.id.science_recyclerview);
        mAdapter = new HeadlinesNewsAdapter(newsList, fragment, thiscontext);
        newsList = getNews(thiscontext, root);

        final SwipeRefreshLayout swipeRefreshLayout = root.findViewById(R.id.swipe_refresh_items_science);
    ...
    private ArrayList<HeadlinesNewsItem> getNews(final Context thiscontext, final View root){
        ...
        String url = "https://node-assignment9-ugru.wl.r.appspot.com/guardian/science";
